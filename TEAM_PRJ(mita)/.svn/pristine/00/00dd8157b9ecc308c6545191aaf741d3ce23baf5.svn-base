	...
	<div class="row">
 		<form class="row g-3" action="#" id="joinForm" onsubmit="return joinMember();">
			...
			<div class="col-md-3">
				...
				<input type="text" class="form-control" id="inputName" name="memName" placeholder="이름" pattern="^[가-힣a-zA-Z]+$" required>
			</div>
			<div class="col-md-6">
				<label for="inputEmail" class="form-label">이메일</label> 
				<input type="email" class="form-control" id="inputEmail" name="memEmail" placeholder="id@email.com" oninput="emailCheckReset();" required>
			</div>
			<div class="col-md-2">
			...
			<div class="col-md-3">
				<label for="" class="form-label">&nbsp;</label> 
				<input type="text" class="form-control" name="memPhone" id="inputPhone2" maxlength="4" pattern="^[0-9]+$" oninput="phoneCheckReset();" required>
			</div>
			<div class="col-md-3">
				<label for="" class="form-label">&nbsp;</label> 
				<input type="text" class="form-control" name="memPhone" id="inputPhone3" maxlength="4" pattern="^[0-9]+$" oninput="phoneCheckReset();" required>
			</div>
			<div class="col-md-2">
				<label for="" class="form-label">&nbsp;</label> 
			...
			<div class="col-12">
				<input type="text" class="form-control" id="inputAddress" placeholder="상세주소" name="memAddr" required>
			</div>
			<div class="col-md-4">
			...
			<div class="col-md-8">
				...
				<input type="text" id="datePicker" class="form-control" name="memBirth" required/>
			</div>
			<div class="mb-3">
