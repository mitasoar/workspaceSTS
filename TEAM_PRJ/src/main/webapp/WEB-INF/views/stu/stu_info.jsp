...
<div class="tableDiv" id="tableDiv">
	<table class="table">
		...
		<tr>
			...
			<td>${sessionScope.loginInfo.memberVO.memName} [${sessionScope.loginInfo.stuNo }] 
				<c:if test="${sessionScope.loginInfo.memberVO.memGender eq 'M'}">
					남
				</c:if>
				<c:if test="${sessionScope.loginInfo.memberVO.memGender eq 'F'}">
					여
				</c:if>
			</td>
		</tr>
