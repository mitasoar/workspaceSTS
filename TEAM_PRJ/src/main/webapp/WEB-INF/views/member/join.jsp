 		...
 		<form class="row g-3" action="#" id="joinForm" onsubmit="return joinMember();">
			<c:choose>
				...
				<c:when test="${joinType eq '2'}">
					<div class="col-12 text-center">교수 등록</div>
					<input type="hidden" name="memType" value="emp">
					<input type="hidden" name="empType" value="pro">
				</c:when>
				<c:when test="${joinType eq '3'}">
					<div class="col-12 text-center">학사직원 등록</div>
					<input type="hidden" name="memType" value="emp">
					<input type="hidden" name="empType" value="emp">
				</c:when>
				<c:when test="${joinType eq '4'}">
			...
			<c:if test="${joinType eq '1' || joinType eq '2'}">
				<div class="col-6">
					<label for="formColl" class="form-label">단과대학</label>
					<select class="form-select" id="formColl" name="collNo" onchange="callDeptList(this);" aria-label="Default select example">
				...
				<div class="col-6">
					<label for="formDept" class="form-label">학과</label>
					<select class="form-select" id="formDept" name="deptNo" aria-label="Default select example">
					</select>
				</div>
			</c:if>
			<div class="col-md-4">
