			      ...
			      <ul class="navbar-nav">
			        ...
			        <li class="nav-item dropdown ms-3 me-3">
			          ...
			          <ul class="dropdown-menu" aria-labelledby="navbarDropdown3">
			          	...
			          	<c:if test="${not empty loginInfo and (loginInfo.memType eq 'stu' or loginInfo.memType eq 'admin')}">
				          	<li><a class="nav-link" href="/board/boardList?cateNo=CATE_1">학생게시판</a></li>
			          	</c:if>
			          	<c:if test="${not empty loginInfo and (loginInfo.empType eq 'pro' or loginInfo.memType eq 'admin')}">
			          		<li><a class="nav-link" href="/board/boardList?cateNo=CATE_2">교수게시판</a></li>
			          	</c:if>
			          	<c:if test="${not empty loginInfo and (loginInfo.empType eq 'emp' or loginInfo.memType eq 'admin')}">
			        ...
			        <c:if test="${not empty loginInfo and (loginInfo.empType eq 'emp' or loginInfo.memType eq 'admin')}">
			       	...
			       	<c:if test="${not empty loginInfo && loginInfo.memType eq 'admin'}">
				        <li class="nav-item dropdown ms-3 me-3">
