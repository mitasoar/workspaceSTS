				...
				<ul class="navbar-nav">
					<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false"> 학생관리 </a>
						<ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
							<li><a class="dropdown-item" href="/admin/studentList">학생 조회</a></li>
							<li><a class="dropdown-item" href="/admin/scoreManage">성적 관리</a></li>
							<li><a class="dropdown-item" href="/admin/academicAppr">학적 변동 승인</a></li>
							<li><a class="dropdown-item" href="/admin/probation">학사경고</a></li>
							<li><a class="dropdown-item" href="/admin/expel">제적</a></li>
							<li><a class="dropdown-item" href="/admin/majorTask">전과 / 복수전공</a></li>
						</ul>
					</li>
